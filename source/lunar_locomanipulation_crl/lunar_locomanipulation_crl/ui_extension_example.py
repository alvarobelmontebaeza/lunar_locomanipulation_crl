...
def some_public_function(x: int):
    print("[lunar_locomanipulation_crl] some_public_function was called with x: ", x)
    return x**x
...
class ExampleExtension(omni.ext.IExt):
    ...
    def on_startup(self, ext_id):
        print("[lunar_locomanipulation_crl] startup")
    ...
    def on_shutdown(self):
        print("[lunar_locomanipulation_crl] shutdown")