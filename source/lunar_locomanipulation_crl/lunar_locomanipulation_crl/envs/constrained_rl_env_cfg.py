...
@configclass
class ConstrainedRlEnvCfg(DirectRLEnvCfg):
   
  constraint_manager: object | None = None
  """Constraint manager to handle constraints in the environment. Default is None, which means no constraint manager is used."""

  constraints: object | None = None
  """List of constraints to be managed by the constraint manager. Default is None."""

  # --- Base configuration of DirectRLEnvCfg below ---
